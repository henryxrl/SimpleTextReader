                        ...
                        _createClass(HyperList, null, [
                            ...
                            },
                            {
                                ...
                                value: function getMaxBrowserHeight() {
                                    ...
                                    var max_fixture_height_factor =
                                        fixture_height_factor + 1;
                                    fixture.style.height =
                                        10 ** max_fixture_height_factor + "px";
                                    ...
                                    if (
                                        ...
                                        if (fixture.offsetHeight === 0) {
                                            var high =
                                                10 ** max_fixture_height_factor;
                                            var low =
                                                10 ** fixture_height_factor;
                                            var cur = high;
                                            var prevcur = high;
                                ...
                                value: function _computeScrollHeight() {
                                    ...
                                    if (config.reverse) {
                                        window.requestAnimationFrame(
                                            function () {
                                                if (isHoriz) {
                                                    _this2._element.scrollLeft =
                                                        scrollHeight;
                                                } else {
                                                    _this2._element.scrollTop =
                                                        scrollHeight;
                                                }
                                            }
                                        );

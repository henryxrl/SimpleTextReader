...
class DropdownSelector {
     ...
     * @public
     */
    constructor($selectElement, defaultIdx, eventListeners = []) {
 ...
 * @public
 */
export function getDropdownSelector($selectElement, defaultIdx, eventListeners = []) {
    return new DropdownSelector($selectElement, defaultIdx, eventListeners);
}

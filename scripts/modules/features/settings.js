 ...
 * - Language settings
 *
 * @module modules/features/settings
 * @requires config
 * @requires lib/css-global-variables
 * @requires modules/components/dropdown-selector
 * @requires modules/components/custom-custom-color-picker
 * @requires utils/base
...
import { isVariableDefined, HSLToHex, hexToHSL, pSBC, triggerCustomEvent } from "../../utils/base.js";
import {
    setRangeValue,
    setColorValue,
    setSelectorValue,

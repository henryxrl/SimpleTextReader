...
*/
function selector_init($selectElement, defaultIdx, EventListenerFunc, EventListenerFuncParameters) {
    ...
    $list.find('li[rel="' + allOptions.eq(defaultIdx).val() + '"]').addClass('is-selected');
}

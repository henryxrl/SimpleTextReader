...
var css_path_darkmode;
injectCustomLink('css/darkmode_toggle.css', function(path) {
    // console.log("css_path_darkmode: ", path);
    css_path_darkmode = path;
});
...
// var font_path_icon;
// injectCustomFont('fonts/icons.woff2', 'font/woff2', function(path) {
//     // console.log("font_path_icon: ", path);
//     font_path_icon = path;
// });
var font_path_title;
...
// });
var font_path_body;
injectCustomFont('fonts/FZKTK.woff2', 'font/woff2', function(path) {
    // console.log("font_path_body: ", path);
    font_path_body = path;
});
var font_path_ui;
...
var interval = setInterval(function() {
    if (isVariableDefined(css_path_darkmode) && isVariableDefined(css_path_ui_variables) && isVariableDefined(css_path_ui) && isVariableDefined(css_path_reader) && isVariableDefined(css_path_footnotes) && /*isVariableDefined(font_path_icon) && */isVariableDefined(font_path_title) && isVariableDefined(font_path_body) && isVariableDefined(font_path_ui) && isVariableDefined(img_path_drop) && isVariableDefined(img_path_seal_CN) && isVariableDefined(img_path_seal_EN) && isVariableDefined(img_path_note_CN) && isVariableDefined(img_path_note_EN) && isVariableDefined(js_path_jquery) && isVariableDefined(js_path_jschardet) && isVariableDefined(js_path_css_global_variables) && isVariableDefined(js_path_regex_rules) && isVariableDefined(js_path_utilities)) {
                        ...
                        var interval4 = setInterval(function() {
                            if (isVariableDefined(css_path_darkmode) && isVariableDefined(css_path_ui_variables) && isVariableDefined(css_path_ui) && isVariableDefined(css_path_reader) && isVariableDefined(css_path_footnotes) && /*isVariableDefined(font_path_icon) && */isVariableDefined(font_path_title) && isVariableDefined(font_path_body) && isVariableDefined(font_path_ui) && isVariableDefined(img_path_drop) && isVariableDefined(img_path_seal_CN) && isVariableDefined(img_path_seal_EN) && isVariableDefined(img_path_note_CN) && isVariableDefined(img_path_note_EN) && isVariableDefined(js_path_jquery) && isVariableDefined(js_path_jschardet) && isVariableDefined(js_path_css_global_variables) && isVariableDefined(js_path_regex_rules) && isVariableDefined(js_path_utilities) && isVariableDefined(js_path_footnotes) && isVariableDefined(js_path_ui_variables) && isVariableDefined(js_path_processText) && isVariableDefined(js_path_ui_helpers) && isVariableDefined(js_path_ui)) {
                                ...
                                injectAllCustomResources('scripts_extension/Firefox/no-ui/receive_loaded_variables.js', function(path) {
                                    ...
                                    injectCustomJs('scripts_extension/Firefox/no-ui/file_handler.js', function(path) {
...
function injectAllCustomResources(jsPath, callback) {
    ...
    temp.src = browser.runtime.getURL(jsPath);
...
function injectCustomIcon(iconPath, iconType)
{
    ...
    temp.rel = 'icon';
    temp.as = 'image';
    temp.href = browser.runtime.getURL(iconPath);
    document.head.appendChild(temp);
}
...
function injectCustomFont(fontPath, fontType, callback) {
    ...
    temp.href = browser.runtime.getURL(fontPath);
    temp.onload = function() {
...
function injectCustomLink(linkPath, callback) {
    ...
    temp.type = 'text/css';
    temp.rel = 'stylesheet';
    temp.href = browser.runtime.getURL(linkPath);
    temp.crossOrigin = 'anonymous';
    temp.onload = function() {
